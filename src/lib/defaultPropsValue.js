...
DefaultPropsValue['arrayOf'] = function (propName, propType, arg) {
  return arg.proptype
    ? [DefaultPropsValue[arg.proptype](propName, propType, arg)]
    : []
}
...
DefaultPropsValue['oneOfType'] = function (propName, propType, arg) {
  return arg[0] && arg[0].proptype
    ? DefaultPropsValue[arg[0].proptype](propName, propType, arg)
    : DefaultPropsValue['any'](propName, propType, arg)
}
...
DefaultPropsValue['shape'] = function (
  propName,
  propType,
  arg,
  { configOptions }
