...
const ACCETPTYPES = ['any', 'array', 'bool', 'func', 'number', 'object', 'string', 'node', 'element', 'symbol', 'instanceOf', 'oneOf', 'oneOfType', 'arrayOf', 'objectOf', 'shape', 'exact']; // Use default props unless customer has defined generate props function
